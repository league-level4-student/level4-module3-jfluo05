...
class ExceptionsTest {
	...
	/*
	 * @Test public void testIndexOOBException() { int[] vars = {0, 1, 2, 3};
	 * 
	 * try { vars[0] = 4; assertArrayEquals(vars, new int[] {4, 1, 2, 3}); vars[4] =
	 * 5; fail("IndexOutOfBoundsException not thrown");
	...
	/*
	 * @Test public void testDivideByZeroException() { try {
	 * ExceptionMethods.divide(4, 0.0); fail("IllegalArgumentException not thrown");
